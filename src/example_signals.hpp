...
"quartic_potential","quartic_potential_2","rotating_quartic_multiwell","quartic_potential_3d"};
set<string> datasets_4d = {"tornado4d","vortex"};
set<string> datasets_3d = {"s3d", "nek", "rti", "miranda", "tornado", "vortex_street_3d","boussinesq_3d","fluid","cylinder","cylinder2","cylinder3"};
...
void evaluate_function(string fun, const VectorX<T>& domain_pt, VectorX<T>& output_pt, DomainArgs& args, int k)
{
    ...
    else if (fun == "quartic_potential_3d") return closed_form_function::quartic_potential_3d(domain_pt, output_pt);
