...
data_type="vortex_street_3d" #boussinesq_3d #vortex_street_3d
...
compare_result="./build/src/${save_folder}/vti_critical_points"
...
python ./src/critical_point_tracking/matching_ratio.py "${tracking_result}_${step_size}.obj" "${compare_result}-${step_size}_rescale.csv" "${spatial_step_size}" "${t_step_size}" --header
