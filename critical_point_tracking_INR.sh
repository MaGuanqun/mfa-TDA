...
for data_type in "cylinder2" #"vortex_street_3d" #"boussinesq_3d"
do
...
python ./src/critical_point_tracking/matching_ratio.py "${tracking_result}_${step_size}.obj" "$csv_file_from_model" "${spatial_step_size}" "${t_step_size}" --header
